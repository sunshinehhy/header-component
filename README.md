...
### For Full Header
```
import {FullHeader} from 'header-component';
...
### For Simple Header
```
import {SimpleHeader} from 'header-component';
...
### For Dynamic Header
```
import {DynamicHeader} from 'header-component';
...
@import 'header-component/main.scss';
```
